...
VAL_END = '2017-08-15'
MAX_GROUPS = 100  # Limit store-family pairs to prevent memory issues
MAX_MODELS = 2    # Limit default models to reduce CPU load
...
# Data processing function (no caching to avoid memory bloat)
